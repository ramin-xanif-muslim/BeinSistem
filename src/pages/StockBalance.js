...
export default function StockBalance() {
  ...
  const { isLoading, error, data, isFetching } = useQuery(
    ["stockbalance", page, direction, fieldSort, doSearch, search, advanced],
    () => {
      return isFilter === true
        ...
        : !isFilter && !doSearch
        ? fetchPage("stockbalance", page, direction, fieldSort, null, 3, 0)
        : null;
    }
  );
  useEffect(() => {
  ...
  const columns = useMemo(() => {
    return [
      ...
      },
      {
        ...
        sorter: (a, b) => null,
        className: initialSort === "ProductName" ? "activesort" : "",
      },
      {
        dataIndex: "BarCode",
        title: "Barkodu",
...

      {
        ...
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "Quantity").show
          : true,
...

      {
        ...
        title: "Maya qiyməti",
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "CostPrice").show
          : true,
      ...
      },
      {
        ...
        title: "Cəm Satış",
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "SalePrice").show
          : true,
  ...
  const filters = useMemo(() => {
    return [
      ...
      },
      {
        ...
        dataIndex: "zeros",
        show: initialfilter
          ? Object.values(initialfilter).find((i) => i.dataIndex === "zeros")
              .show
          : true,
      },
    ];
