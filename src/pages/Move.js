  ...
  const columns = useMemo(() => {
    return [
      ...
      },
      {
        ...
        title: "Anbardan",
        defaultSortOrder: initialSort === "StockFromName" ? defaultdr : null,
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "StockFromName")
              .show
          : true,
        sorter: (a, b) => null,
      },

      {
        ...
        title: "Anbara",
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "StockToName")
              .show
          : true,
        defaultSortOrder: initialSort === "StockToName" ? defaultdr : null,
        sorter: (a, b) => null,
      },
