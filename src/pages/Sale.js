  ...
  const { isLoading, error, data, isFetching } = useQuery(
    ...
    () => {
      return isFilter === true
        ? fetchFilterPage("sales", advancedPage, advanced, direction, fieldSort)
        : doSearch
  ...
  const columns = useMemo(() => {
    return [
      ...
      },
      {
        ...
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "Bank").show
          : true,
        sorter: (a, b) => null,
      },
      {
        ...
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "UseBonus").show
          : true,
        sorter: (a, b) => null,
      },
      {
        ...
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "Credit").show
          : true,
        sorter: (a, b) => null,
      },
      {
        ...
        render: (value, row, index) => {
          return parseFloat(row.Amount + row.Bank + row.Credit + row.UseBonus);
        },
      },
      {
        dataIndex: "StockName",
                ...
                <Table.Summary.Cell>
                  <Text type="">
                    {c.dataIndex === "Amount"
                      ...
                      ? parseFloat(allsum + allbank + allbonus) + " ₼"
                      : null}
                  </Text>
                </Table.Summary.Cell>
              ))}
