  ...
  const filters = useMemo(() => {
    return [
      ...
      },
      {
        ...
        dataIndex: "card",
        show: initialfilter
          ? Object.values(initialfilter).find((i) => i.dataIndex === "card")
              .show
          : true,
      },
      {
        ...
        dataIndex: "phone",
        show: initialfilter
          ? Object.values(initialfilter).find((i) => i.dataIndex === "phone")
              .show
          : true,
      },

      {
        ...
        dataIndex: "bonus",
        show: initialfilter
          ? Object.values(initialfilter).find((i) => i.dataIndex === "bonus")
              .show
          : true,
      },
      {
      ...
      },
      {
        ...
        dataIndex: "email",
        show: initialfilter
          ? Object.values(initialfilter).find((i) => i.dataIndex === "email")
              .show
          : true,
      },
    ];
