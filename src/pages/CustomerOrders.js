...
export default function CustomerOrders() {
  ...
  const { isLoading, error, data, isFetching } = useQuery(
    ["customerorders", page, direction, fieldSort, doSearch, search, advanced],
    () => {
  ...
  const columns = useMemo(() => {
    return [
      ...
      },
      {
        ...
        title: "Sifariş növü",
        defaultSortOrder: initialSort === "OrderStatus" ? defaultdr : null,
        show: initial
          ? Object.values(initial).find((i) => i.dataIndex === "OrderStatus")
              .show
          : true,
        sorter: (a, b) => null,
        ...
        render: (value, row, index) => {
          return (
            <Tag color="cyan">
              {orderstatusarray.find((m) => m.Id === String(value))
                ? orderstatusarray.find((m) => m.Id === String(value)).Name
                : null}
            </Tag>
          );
        },
      ...
      },
      {
        ...
        className: initialSort === "CustomerDiscount" ? "activesort" : "",
        title: "Müştəri Endirim",
        defaultSortOrder: initialSort === "CustomerDiscount" ? defaultdr : null,
        show: initial
