...
function NewSupply() {
  ...
  return (
    <div className="doc_wrapper">
      ...
      <DocButtons editid={null} closed={"p=supply"} />
          ...
          <Row>
              ...
              <Col xs={24} md={24} xl={8}>
                <div className="input-with-icon-btn" >
                  <Form.Item label="Anbar" name="stockid" style={{width: "70%"}}>
                    <Select
                      size="small"
                      showSearch
                      showArrow={false}
              ...
              <Col xs={24} md={24} xl={8}>
                <div className="input-with-icon-btn" >
                    <Form.Item label="Qarşı-tərəf" name="customerid"  style={{width: "80%"}}>
                        <Select
                          size="small"
                          showSearch
                          showArrow={false}
          ...
          <Row>
            <Collapse ghost style={{width: "100%"}}>
              <Panel className="custom_panel_header" header="Təyinat" key="1">
                ...
                <Row>
                  <Col xs={24} md={24} xl={8}>
                    <Form.Item label="Status" name="mark" style={{width: "100%"}}>
                      <StatusSelect />
                    </Form.Item>
                  </Col>
                  <Col xs={24} md={24} xl={8}>
                ...
                <div className="static_wrapper">
                  ...
                  <div style={{ marginTop: "20px" }}>
                    <Form.Item
                      ...
                      name="consumption"
                    >
                      <Input ref={myRefConsumption} type="number" step="any" />
                    </Form.Item>
                  </div>
                </div>
              </Col>
