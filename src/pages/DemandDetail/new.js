...
function NewDemand({
  ...
  const columns = useMemo(() => {
    return [
      ...
      },
      {
        ...
        isVisible: initial
          ? Object.values(initial).find((i) => i.dataIndex === "vahid")
              .isVisible
          : false,
        editable: false,
        sortDirections: ["descend", "ascend"],
      ...
      },
      {
        ...
        className: "max_width_field",
        isVisible: initial
          ? Object.values(initial).find((i) => i.dataIndex === "MinPrice")
              .isVisible
          : false,
        editable: false,
        sortDirections: ["descend", "ascend"],
      ...
      },
      {
        ...
        isVisible: initial
          ? Object.values(initial).find((i) => i.dataIndex === "addSame")
              .isVisible
          : false,
        editable: false,
        render: (_, record) => (
  ...
  }, [consumption, outerDataSource, docSum, columnChange, prices, docPage]);
            ...
            <Col xs={6} sm={6} md={6} xl={6}>
              ...
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Zəhmət olmasa, qarşı tərəfi seçin",
                  },
                ]}
                label="Qarşı-tərəf"
                name="customerid"
...
export default withTreeViewModal(withCatalog(NewDemand));
