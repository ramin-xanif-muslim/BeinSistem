          ...
          >
            <Row>
              <Col xs={12} sm={8} md={8} xl={8}>
                <Row>
                  <Col>
                    <h3 style={{ marginBottom: "2.6rem" }}>Ümumi məlumat</h3>
                  </Col>
                  <Col className="left_wrapper" xs={24} sm={24} md={24} xl={24}>
                    <Form.Item
                      label="Məhsulun adı"
                      name="name"
                      rules={[
                    ...
                    >
                      <Input className="detail-input" allowClear={true} />
                    </Form.Item>
                  </Col>
                  <Col className="left_wrapper" xs={24} sm={24} md={24} xl={24}>
              ...
              <Col xs={8} sm={8} md={8} xl={8}>
                <Collapse ghost>
                  <Panel
                    ...
                    key="1"
                  >
                    <Form.Item label={"Cavabdeh"} name="ownerid">
                      <Select
                        className="detail-select"
                        showSearch
                        filterOption={false}
