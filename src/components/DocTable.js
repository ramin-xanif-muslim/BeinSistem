            ...
            var newData = {
                ...
                PackQuantity: from
                    ? from === "demands"
                        ...
                        : ""
                    : "",
                StockQuantity: newPro.stockquantity
                    ? newPro.stockquantity
                    : "0.00",
        ...
        if (isCatalog) {
            ...
            selectList.map((s) =>
                datas.push({
                    ...
                    CostPriceTotal: `${
                        parseFloat(s.CostPrice) * parseFloat(1)
                    }`,
                })
            );
    ...
    const handleSave = (row) => {
        ...
        item.Quantity != newData[index].Quantity
            ? newData.map((n) => {
                  if (n.ShowPacket) {
                      n.TotalPrice =
                          parseFloat(n.PackPrice) * parseFloat(n.Quantity);
                  } else {
                      n.TotalPrice =
            ...
            ? newData.map(
                  (n) =>
                      (n.TotalPrice =
                          parseFloat(n.Price) *
                          parseFloat(
                              n.ShowPacket ? n.ChangePackQuantity : n.Quantity
                          ))
              )
